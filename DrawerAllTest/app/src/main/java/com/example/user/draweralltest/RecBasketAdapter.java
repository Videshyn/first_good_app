...
public class RecBasketAdapter extends RecyclerView.Adapter<RecBasketAdapter.ViewHolder> {
    ...
    public RecBasketAdapter(Context context) {
    ...
    private void fillArrays() {
        ...
        Cursor cursor = database.rawQuery("SELECT * from Products WHERE p_basket=?", new String[] {"true"});
        if (cursor != null) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new RecBasketAdapter.ViewHolder(cardView);
    }
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, ProductInBasketActivity.class);
